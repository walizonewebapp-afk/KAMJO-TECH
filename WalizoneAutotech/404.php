...
<head>
  ...
  <title>Page Not Found - Walizone Autotech</title>
  <meta name="description" content="The page you're looking for could not be found at Walizone Autotech.">
...
<body>
  ...
  <div class="error-container">
    ...
    <p class="error-message">Oops! The page you're looking for seems to have taken a detour. Our mechanics are working on getting it back on the road, but in the meantime, let's get you back on track.</p>
    
    <div class="car-animation">
      <img src="https://cdn-icons-png.flaticon.com/512/3097/3097180.png" alt="Car" class="car" width="100">
    </div>
    ...
    <div class="error-actions">
      ...
      <a href="services.php" class="btn">
        <i class="fas fa-wrench"></i> View Our Services
      </a>
    ...
    <div class="error-links">
      ...
      <div class="quick-links">
        <a href="services.php"><i class="fas fa-oil-can"></i> Routine Maintenance</a>
        <a href="services.php"><i class="fas fa-laptop"></i> Computer Diagnostics</a>
        <a href="services.php"><i class="fas fa-cogs"></i> Engine Repair</a>
