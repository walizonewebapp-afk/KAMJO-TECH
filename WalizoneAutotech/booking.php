...
$services = [];
$servicesQuery = "SELECT * FROM services ORDER BY name";
...
// If no services in database, use this default list
if (empty($services)) {
    $services = [
        ['id' => 1, 'name' => 'Routine Maintenance'],
        ['id' => 2, 'name' => 'Computer Diagnostics'],
        ['id' => 3, 'name' => 'Engine & Transmission Repair'],
        ['id' => 4, 'name' => 'AC & Heating Services'],
        ['id' => 5, 'name' => 'Suspension & Steering'],
        ['id' => 6, 'name' => 'Panel Beating & Painting'],
        ['id' => 7, 'name' => 'Electrical Systems'],
        ['id' => 8, 'name' => 'Custom Modifications']
    ];
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $checkTable = "SHOW TABLES LIKE 'appointments'";
        $tableExists = $conn->query($checkTable);
        
        if ($tableExists->num_rows == 0) {
            // Create appointments table
            $createTable = "CREATE TABLE appointments (
        ...
        try {
            $stmt = $conn->prepare("INSERT INTO appointments (name, email, phone, service, appointment_date, appointment_time, message, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, NOW())");
            ...
            if ($stmt->execute()) {
                ...
                $errors['general'] = 'Sorry, there was an error processing your booking. Please try again.';
            }
...
<head>
  ...
  <title>Book an Appointment - Walizone Autotech</title>
  <meta name="description" content="Book an appointment with Walizone Autotech Enterprise for professional automotive services in Chinsali, Zambia.">
...
<body>
  ...
  <section class="page-header">
    ...
    <p>Schedule your vehicle service with Walizone Autotech</p>
  </section>
  ...
  <div class="main-content">
    <?php if ($success): ?>
      <div class="alert alert-success">
        ...
        <p>Thank you for booking an appointment with Walizone Autotech. We have received your request and will confirm your appointment shortly.</p>
    ...
    <div class="card">
      ...
      <p>Please fill out the form below to book an appointment for your vehicle service. Our team will confirm your appointment as soon as possible.</p>
      ...
      <div class="info-box">
        ...
        <ul class="info-list">
          <li>
            ...
            <span>Operating Hours: Monday - Saturday, 8:00 AM - 5:00 PM</span>
          </li>
          <li>
            <i class="fas fa-calendar-check"></i>
            <span>Same-day appointments may be available depending on our schedule</span>
          </li>
          <li>
            <i class="fas fa-phone"></i>
            <span>For urgent services, please call us at <a href="tel:+260976664017" style="color: var(--primary-color);">0976664017</a></span>
          </li>
          <li>
          ...
          <li>
            ...
            <span>Don't forget to bring your vehicle's service history if available</span>
          </li>
        </ul>
      </div>
      ...
      <form class="booking-form" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
        ...
        <div class="form-group">
          ...
          <select id="service" name="service" class="form-control" required>
            <option value="" disabled <?php echo empty($service) ? 'selected' : ''; ?>>Select a service</option>
            <?php foreach ($services as $srv): ?>
              <option value="<?php echo htmlspecialchars($srv['name']); ?>" <?php echo $service === $srv['name'] ? 'selected' : ''; ?>>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="date" id="date" name="date" class="form-control" value="<?php echo htmlspecialchars($date); ?>" min="<?php echo date('Y-m-d'); ?>" required>
          ...
          <div class="form-group">
            ...
            <select id="time" name="time" class="form-control" required>
              <option value="" disabled <?php echo empty($time) ? 'selected' : ''; ?>>Select a time</option>
              <option value="08:00" <?php echo $time === '08:00' ? 'selected' : ''; ?>>8:00 AM</option>
        ...
        <div class="form-group">
          ...
          <textarea id="message" name="message" class="form-control" placeholder="Please provide any additional details about your vehicle or service needs"><?php echo htmlspecialchars($message); ?></textarea>
        </div>
