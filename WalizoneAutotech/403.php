...
<head>
  ...
  <title>Access Denied - Walizone Autotech</title>
  <meta name="description" content="Access to this page is restricted at Walizone Autotech.">
...
<body>
  ...
  <div class="error-container">
    ...
    <p class="error-message">Sorry, you don't have permission to access this page. This area might be restricted to authorized personnel only.</p>
    
    <div class="lock-animation">
      <img src="https://cdn-icons-png.flaticon.com/512/2913/2913133.png" alt="Lock" class="lock" width="150">
    </div>
    ...
    <div class="error-links">
      ...
      <div class="quick-links">
        <a href="index.php#services"><i class="fas fa-wrench"></i> Our Services</a>
        <a href="booking.php"><i class="fas fa-calendar-alt"></i> Book an Appointment</a>
